    ...
    <header>
		<nav class="bg-light navbar navbar-expand-lg p-3 fixed-top">
			...
			<div class="collapse navbar-collapse justify-content-center" id="navcont">
				<ul class="navbar-nav">
				  <li class="nav-item">
					<a class="nav-link" href="#"><i class="icon-search"></i> Search</a>
				  </li>
				  <li class="nav-item">
					<a class="nav-link" href="#"><i class="icon-chat"></i> Chat</a>
				  </li>
				  <li class="nav-item">
					<a class="nav-link" href="#"><i class="icon-heart"></i> Favorites</a>
				  </li>
				</ul>
			</div>
		</nav>
